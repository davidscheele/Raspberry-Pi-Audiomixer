...
def loadMusicStyles():	
	with open('/home/david/Raspberry-Pi-Audiomixer/musicstyleorder') as file:
		musicStyleDict = {}
		counter = 1
		for line in file:
			if line[0] != "#":
...
warnSound = "/home/david/Raspberry-Pi-Audiomixer/warning.ogg"
...
musicChannelA = pygame.mixer.Sound("/home/david/Raspberry-Pi-Audiomixer/silence-1-second.wav").play()
musicChannelB = pygame.mixer.Sound("/home/david/Raspberry-Pi-Audiomixer/silence-1-second.wav").play()
currentPlaylist = []
sfxDict = defaultdict(list)

def getRandomPlaylistOf(directory):
	finaldir = "/home/david/Raspberry-Pi-Audiomixer/sound/" + directory + "/bgm/*"
	playlist = []
...
def loadSoundEffects(directory):
	...
	print(directory)
	sfxDict = defaultdict(list)
	finaldir = "/home/david/Raspberry-Pi-Audiomixer/sound/" + directory + "/sfx/"
...
def playByKey(key):
	...
	if currentMusicStyle != "0":
		if key in sfxDict:
			sfxToPlay = "/home/david/Raspberry-Pi-Audiomixer/sound/" + musicStyleDict[currentMusicStyle] + "/sfx/" + random.choice(sfxDict[key])
			print("I'll play...")
			print(sfxToPlay)
